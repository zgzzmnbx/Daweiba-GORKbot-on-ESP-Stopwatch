...
用户已确定 **StopWatch 主开发机器人交互，语音项目维护独立识别/合成接口**。首轮电脑收音出声、现有 BLE 表情与气泡联动；设备自身音频和造价业务另行推进。见 [本轮交接入口](00-docs/02-交接/电脑语音交互首轮任务书-v1.0.0-【codex】.md)。交接文档 v1.0.0；当前软件/固件运行版本不因文档交接改变，机器人交互尚待开发。
